...
CREATE TABLE `movieq` (
  ...
  `movieqHint1` varchar(100) NOT NULL,
  `movieqHint2` varchar(100) NOT NULL,
  `movieqHint3` varchar(100) NOT NULL,
  `movieqHint4` varchar(100) NOT NULL,
  `movieqHint5` varchar(100) NOT NULL,
...
-- Dump completed on 2022-11-18 12:10:40
